...
### hello
used to test the idf installetion by runing: -idf   | create-project project_name
                                                    | build
                                                    | flash
                                                    | monitor
### motionSensor
Understanding PIR pins, and incoporates -idf drivers | gpio.h -controll the input/output pins
